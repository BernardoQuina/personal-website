    ...
    if (variant === 'rainbow') {
      return (
        <div className={cn('group relative', className)}>
          <span
            className="absolute inset-0 animate-rainbow-pulsate rounded-md bg-[linear-gradient(90deg,theme('colors.red.300'),theme('colors.purple.300'),theme('colors.blue.300'),theme('colors.cyan.300'),theme('colors.blue.300'),theme('colors.purple.300'),theme('colors.red.300'))] bg-[length:200%] group-hover:animate-rainbow group-hover:blur-[6px]"
            aria-hidden="true"
          ></span>
          <Comp
